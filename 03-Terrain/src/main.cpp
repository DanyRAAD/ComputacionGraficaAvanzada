...
void applicationLoop() {
	...
	while (psi) {
		...
		shaderMulLighting.setVectorFloat2("sacaleUV",glm::value_ptr(glm::vec2(50.0))); //repeticion de imagen
		terreno.render();
		//terreno.enableFillMode();
		shaderMulLighting.setVectorFloat2("sacaleUV",glm::value_ptr(glm::vec2(1.0)));
		glBindTexture(GL_TEXTURE_2D,0);
		 ...
		 * **************************************/
		glm::vec3 normal = terreno.getNormalTerrain(modelMatrixMayow[3][0],modelMatrixMayow[3][2]); //vector de 3 elementos eje y 
