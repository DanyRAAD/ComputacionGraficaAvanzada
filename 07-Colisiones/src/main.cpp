...
void applicationLoop() {
	...
	while (psi) {
		...
		modelMatrixMayow[3][1] = -GRAVITY * tmv * tmv + 3.9 * tmv + terrain.getHeightTerrain(modelMatrixMayow[3][0], modelMatrixMayow[3][2]); //tiro parabolico
		...
		glm::vec3 des = ori + rayDirection * maxDistanceRay;
